...
public enum PokemonType { Normal, Fire, Water, Electric, Grass, Poison, Ground, Flying, Bug, Rock, Ghost, Unknown }

namespace Week13ManagingApplicationData
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            Console.WriteLine($"Fetched at: {DateTime.Now}, took {(DateTime.Now - startTime).TotalSeconds:F1}s");
        }
        ...
        static void PrintPokemonSummary(PokemonDetails pokemon, int number)
        {
            ...
            {
                PokemonType typeEnum = Enum.TryParse<PokemonType>(pokemon.Types[i].Type.Name, true, out var t) ? t : PokemonType.Unknown;
                typeNames += typeEnum;
